...
const CallInfo = ({ callDate, callTime, callFrom, callTo, typeCall, source, billSec }) => {
  //! State
  ...
  return (
    <Grid container spacing={2} mb={2}>
      ...
      {/*  */}
      <Grid className={classes.renderItem} item xs={3}>
        <span className={classes.renderTypeCall}>{typeCall}</span>
      </Grid>
      <Grid className={classes.renderItem} item xs={4}>
